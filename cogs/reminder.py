...
class Reminder(commands.Cog):
    ...
    async def on_ready(self):
        try:
            ...
            # Bot disconnected
            self.send_reminders.restart()

    @commands.command()
    async def reminder(self, ctx, subcommand='help', *args):
        ...
        if (subcommand == 'help'):
            ...
            try:
                ...
                indicator = args[0].lower() # used in remind by month or wkday
                reminder_hour = 8
                reminder_minute = 0
                ...
                await ctx.send('Invalid reminder format! Type "!reminder" to '
            ...
            if len(active_reminders) == 0:
                ...
                await ctx.send('Which of the following reminders would you '
                        'like to remove?\n```' 
                ...
                try:
                    ...
                    await ctx.channel.send('Invalid input, canceling '
                                        'reminder removal. Please try again!')
                    return
    ...
    async def send_reminders(self):
        ...
        for reminder in remaining_reminders:
            ...
            author = self.bot.get_user(int(reminder_parts[2]))
            channel = self.bot.get_channel(int(reminder_parts[3]))
